...
export const EntityHeader = ({
    title, description, onNew, newButtonLabel, newButtonHref, disabled, isCreating
}: EntityHeaderProps) => {
    return (
...
export const EntityContainer = ({
    search, pagination, children, header
...
export const EntityItem = ({
 ...
 return (
    <Link href={href} prefetch>
        ...
        >
        <CardContent className="flex flex-row items-center justofy-between p-0">
